...
function App() {
    ...
    console.log(searchConditions.food)
    console.log(searchConditions.location)
        ...
        <HashRouter>
            <div className="d">
                ...
                <div className="style-bg">
                    <Routes>
                        <Route path="/FoodPilot/home" element={<Home searchConditions={searchConditions} setSearchConditions={setSearchConditions}/>} />
                        ...
                        <Route path="/FoodPilot/search" element={<Search searchConditions={searchConditions} setSearchConditions={setSearchConditions}/>} />
